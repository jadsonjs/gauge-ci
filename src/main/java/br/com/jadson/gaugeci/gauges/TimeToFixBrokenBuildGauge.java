 ...
 */
@Component
public class TimeToFixBrokenBuildGauge {
    ...
    public TimeToFixBrokenBuildGauge(){
     ...
     */
    public TimeToFixBrokenBuildGauge(String successStatusLabel, String failedStatusLabel){
        this();
        // pre condition
