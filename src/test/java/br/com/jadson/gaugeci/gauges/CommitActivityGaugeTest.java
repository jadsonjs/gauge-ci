...
class CommitActivityGaugeTest {
    ...
    void calcCommitsActivity100PercentNotSpringProjects() throws ParseException {
        ...
        PeriodOfAnalysis periodOfAnalysis = new CommitActivityGauge().calcCommitsActivity(commitsInfo, startReleaseDate, endReleaseDate);
